...
class Serie:
    ...
    def __str(self):
        cad = "{:<30}{:>20}{:<12}{:>4}{:>6}"
        return cad.format(self.titulo, GENEROS[self.genero], IDIOMAS[self.idioma], self.temporadas, self.duracion)
...
def motrar_titulos():
    cad = "{:<30}{:<20}{:<12}{:<4}{:>6}".format('Titulo0', 'Genero', 'Idioma', 'Temp', 'Durac')
    print(cad)
